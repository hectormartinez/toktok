...
Om arbetsinkomsten under ett år överstiger det s_k basbeloppet vid samma års ingång med minst hundra kronor är inkomsten pensionsgrundande för ATP . 
...
Årsklass 1905 kan t_ex få högst 11/20 av full pension , årsklass 1906 kan få högst 12/20 och årsklass 1907 kan få högst 13/20 . 
Särskilda folkpensionsförmåner 
Kommunalt bostadstillägg är ett tillägg till bl_a ålderspension och utgår enligt grunder som varje kommun själv bestämmer . 
...
Om pensionären är en gift kvinna utgår f_n inte barntillägg . 
Invaliditetstillägg kompletterar i vissa fall ålderspension , om pensionären inte kan reda sig själv och vid upprepade tillfällen dagligen behöver hjälp av annan person . 
Hjälpbehovet skall ha uppstått innan pensionären fyller 63 år . 
Den som är blind har alltid rätt till invaliditetstillägg om blindheten inträffat före 63 år . 
Invaliditetstillägget utgör 30 procent av basbeloppet ( i juli 1971 var det 2070 kr för år räknat ) . 
Om förtidspension eller sjukbidrag samt änkepension och barnpension kan Ni läsa i särskilda broschyrer som finns att hämta på försäkringskassan . 
...
I nästan alla u-länder finns de för utvecklingen nödvändiga tillgångarna såsom arbetskraft , jord , vatten , mineraler , skog o_s_v . 
...
Andra egenskaper utmärkande för u-länder är arbetslöshet ; analfabetism , d_v_s brist på läs- och skrivkunnighet ; låg medellivslängd . 
Man kan också mäta ett lands standard med sådana mått som antal läkare , lärare , böcker , tidningar , telefoner , radioapparater , bilar o_s_v per invånare . 
...
Många av de länder , som i dag kallas underutvecklade , har en kultur långt äldre än t_ex den europeiska . 
...
1700- och 1800-talens industrialisering i England , Frankrike , Tyskland , Holland o_s_v förutsatte en ordnad försörjning med råvaror för industrin ( bomull , jute , hampa , metaller , gummi ) . 
...
Jordens sammanlagda befolkning ökar f_n med 70-80 miljoner människor om året , och ökningen är störst där människorna är fattigast . 
...
Här nedan kan man läsa om några huvuddrag i äktenskapslagstiftningen . 
I Socialkatalogen finns vidare upplysningar om bl.a. barn- och ungdomsfrågor , bostadsfrågor , försäkringsskydd , arv och andra familjerättsliga frågor . 
Giftemål 
När man ska gifta sig måste detta anmälas till pastorsexpeditionen där man bor . 
På pastorsexpeditionen kan man begära , att äktenskapet utlyses i kyrkan ( lysning ) om man så önskar . 
Där får man också upplysning om hur kyrklig och borgerlig vigsel går till . 
Den som är under 20 år ska ha föräldrarnas samtycke för att gifta sig . 
Är han eller hon under 18 år behövs också särskilt tillstånd från länsstyrelsen . 
När man har gift sig innebär det att båda makarna får omfattande personliga och ekonomiska skyldigheter mot varandra . 
Makarna har bl.a. skyldighet att försörja varandra . 
Vidare uppkommer giftorätt . 
Denna innebär bl.a. att vardera maken vid äktenskapets upplösning har rätt till hälften av den andre makens tillgångar . 
Man kan dock avtala om att sådan egendom som annars skulle ha ingått i giftorätten ska vara enskild egendom . 
Ett sådant avtal kallas äktenskapsförord . 
Äktenskapsförordet ska inregistreras hos domstol för att bli giltigt . 
Föräldrar har vårdnaden om sina barn . 
De har alltså ansvar och omsorg om barnen . 
De företräder barnen utåt i olika frågor och de är skyldiga att bekosta barnens uppehälle och uppfostran . 
...
Denna dom kallas hemskillnadsdom . 
Den kan sökas hos domstolen av båda makarna tillsammans . 
Då behöver inte annat skäl uppges än att de är överens om att inte fortsätta att leva tillsammans . 
Om bara den ena maken vill ha hemskillnad måste han eller hon stämma den andra inför domstol . 
Innan man begär hemskillnad är man skyldig att begära medling hos präst eller hos medlare , som är utsedd av kommunen . 
Hemskillnadstiden är till för att ge makarna en prövotid . 
Om de har börjat samlevnaden på nytt under hemskillnadstiden , vilket de får göra , upphävs hemskillnaden utom i fråga om ekonomiska förhållanden . 
Äktenskapsskillnad 
Om makarna har levt var för sig ( hemskilda ) under minst ett år , kan en eller båda begära att domstolen dömer till äktenskapsskillnad . 
Det innebär att äktenskapet upplöses . 
Bl.a. i samband med otrohet kan domstolen döma till omedelbar äktenskapsskillnad utan föregående hemskillnad . 
Både vid hemskillnad och äktenskapsskillnad ska domstolen fastställa vem av makarna som ska ha vårdnaden om barnen . 
Om ingen av makarna bedöms vara lämplig att ha vårdnaden kan särskild förmyndare utses . 
Domstolen avgör vidare om det ska betalas underhållsbidrag , hur boet ska delas och om eventuellt skadestånd . 
Se också Förmyndare sida 12 och Underhållsbidrag sida 23 . 
Man vänder sig till familjerådgivningsbyrå , medlare , härads- eller rådhusrätt , rättshjälpsanstalt eller advokat . 
...
Städer i u-länderna växer explosionsartat , beroende bl_a på jordbrukets mekanisering . 
...
Den lär inte ut de praktiska kunskaper som behövs för att förbättra jordbruket t_ex . 
...
Militära utgifter slukar t_ex 159000 miljoner dollar , medan utbildningen bara får 111000 miljoner . 
...
- Rubrikerna om gifthalterna i bland annat strömming har resulterat i nästan totalstopp för strömmingsförsäljningen i större delen av Sverige , säger direktör John Erik Boork , direktör i Ostkustfisk Centralförening till Aftonbladet . 
...
Det är för övrigt samma operationsmetod som användes hos barn som föds med s_k vattenskalle . 
...
De rapporter som föreligger har trots detta motiverat en planmässig forskning , bl_a på lasarettet i Lund , ett projekt där både psykiater , neurologer , neurokirurger och röntgenologer är engagerade . 
...
Genom den utrustning som finns på röntgendiagnostiska avdelningen vid lasarettet i Lund , en s_k gammakamera , finns nu möjligheter att studera dessa cirkulationsförhållanden . 
...
300 vårddagar 
Gammakameran ger inte lika fullständig bild av hjärnan som en s_k luftskalle eller en s_k färgskalle , men båda dessa undersökningar är besvärande för patienten och kräver också att patienten intages på sjukhus . 
...
Den kan t_ex användas också för att spåra tumörer i exempelvis skelett , lungor och njurar . 
...
Med s_k hjärnscintigrafi får forskarna en sådan här bild av patientens hjärna på ett mycket enkelt sätt . 
...
Om en sådan påfrestning blir långvarig , kan resultatet bli ett tillstånd av s_k stress , ett slags spänningstillstånd , som beror på att vissa försvarsmekanismer i kroppen trätt i funktion . 
...
Man kan nämna bedövningsmedel som kloroform och eter , smärtstillande medel som morfin- och barbitursyrepreparat m_fl . 
...
Hallucinogener 
På senare tid har det skrivits och talats mycket om en del ämnen , som framkallar egendomliga psykiska tillstånd med bl_a hallucinationer och som därför ofta kallas hallucinogener . 
...
Som förut framhållits har stimulantia och narkotika , d_v_s uppiggande och bedövande medel , varit kända i alla tider och överallt . 
...
Redan efter några dagars behandling t_ex på sjukhus kan tillvänjning och beroende uppstå . 
...
De ämnen , som direkt stimulerar centrala nervsystemet , t_ex amfetaminer och kokain , har inte samma fysiologiska tillvänjningseffekt , men de kan leda till ett starkt psykiskt beroende och till svåra rubbningar vid långvarigt bruk . 
Bruk av alkohol och narkotika i små doser kan innebära en omedelbar fara , t_ex för trafikolyckor , eftersom omdömet trubbas av och reaktionstiden förlängs . 
...
Vid alkoholism uppstår t_ex förändringar i levercellens mitokondrier . 
...
Bostadspolitiken från 1920-talet och fram t_o_m krigsslutet 
...
Man avvecklade t_o_m de begränsade insatser på bostadsmarknaden som gjorts under första världskriget . 
...
Ett försök till familjevänligare bostadspolitik var också de bidrag som gavs till kommuner som byggde s_k barnrikehus . 
...
Av bilden framgår ' ramen ' d_v_s bärande väggar samt vatten och avlopp . 
...
I den statliga bostadspolitik som gällt t_o_m 1967 har staten givit stora ekonomiska bidrag till bostadsbyggandet . 
...
Fr_o_m 1968 har den statliga bostadslånepolitiken radikalt förändrats . 
De tidigare subventionerna har borttagits . 
I princip ska de reella kostnaderna för en fastighet belasta densamma . 
I avsikt att neutralisera den kostnadshöjande effekten av detta har införts s_k paritetslån , vars innebörd är att en del av de kostnader för en fastighet som skulle betalas när denna är ny , skjuts framåt i tiden . 
...
För att stimulera barnfamiljernas efterfrågan på bostäder av tillfredsställande storlek och standard har fr_o_m 1969 införts statliga och kommunala bostadstillägg . 
...
Vi upplever f_n en befolkningsexplosion . 
...
Det talas sällan om att det är kvinnan som behöver sina barn och sin man för att se sig själv som en allmänt accepterad individ i samhället . 
Mannen och barnen är ju i själva verket hennes sociala status . 
Var har en kvinna makt och en känsla av att hon är någonting väsentligt - och kan nå det så enkelt ? 
Det är i hemmet ! 
Kvinnan borde basera sitt liv på sina egna personliga prestationer . 
Äktenskapet som en försörjningsmöjlighet borde helt försvinna . 
Då först är det möjligt för två ekonomiskt oberoende människor att skapa en gemensam tillvaro med större förståelse och mera gemenskap . 
Genom att båda delar yrkeslivet går det naturligare att dela hemarbetet också mellan makarna . 
Visst kommer var och en att möta en del svårigheter , men de är till för att övervinnas . 
Det är naturligtvis också fråga om att mannen får undvara den personliga servicen hemma lika mycket som att kvinnan delar den ekonomiska bördan med mannen . 
Barnen klarar sig bra och bättre om man uppmuntrar dem att fungera självständigt . 
Kvinnan behöver inga överflödiga varuhusronder eller dylikt för att pigga upp sitt humör . 
Kontakten mellan familjemedlemmarna behöver inte vara kontinuerlig , men den bör vara av bra kvalitet . 
Hur ska våra barn ha det för att trivas och få den bästa starten i livet ? 
Hur löser man bäst barntillsynsproblemen ? 
Varför dominerar kvinnorna de första åren i barnens liv ? 
Hör de människorna som tar hand om våra barn till de väl avlönade ? 
Det är så viktigt att våra barn ska bli lyckliga medborgare i världen ! 
Har vi någonsin frågat oss om människorna som arbetar med våra barn i daghem , lekskolor , skolor , är tillräckligt intresserade och ' inne ' i yrket att ta hand om våra barn ? 
Hur arbetar de pedagogiskt ? 
Hur pass mycket och i vilken riktning indoktrinerar de våra barns tänkande och handlande ? 
Jag har inte tänkt på de här frågorna så mycket tidigare - i varje fall har jag inte tänkt att jag skulle kunna ändra på det som jag eventuellt har kritiserat . 
Jag - och många med mig - har tänkt att när skolan tar över är allting bra . 
Men hur är det med undervisningen när det gäller att sudda ut könstänkandet ? 
För utlänningar är det ju roligt att berätta - för de uppskattar det - att våra pojkar har hemkunskap i sjuan . 
Men använder de kunskaperna i till exempel matlagning hemma ? 
Barnen är kvinnodominerade och blir ensidigt påverkade från allra första början . 
Mor sköter om dem , hon är hemma . 
Daghemmens personal är kvinnlig . 
Barnen får den uppfattningen att det där med barn och kvinnor hör bestämt ihop . 
Men är det verkligen så ? 
Om det inte är så måste väl den onda cirkeln brytas ! 
Industritjänstemannaförbundet har ställt samman en upplysande tabell över ' hur manliga och kvinnliga medlemmar fördelar sig på olika s.k. befattningsskikt inom företagen ' . 
Ungefär 80 procent av kvinnorna arbetar på de lägsta nivåerna mot ungefär 20 procent av männen . 
Kvinnorna har praktiskt taget ingen möjlighet att nå de höga befattningarna inom industrin , inte ens någon mellanposition utom i undantagsfall . 
Hur skulle de kunna det ? 
Procentuellt är ju kvinnorna färre i de tekniska yrkena . 
Fortfarande siktar våra döttrar hellre på äktenskapet som yrke . 
Eller de vill ha kvinnliga yrken , helst sådana som kan kombineras med tillvaron som hemmafru eller yrken som hjälper dem att bli hemmafruar . 
För mannen skall man inte besvära med hemmatjänst och barnavård , det skulle bli för svårt att genomföra , tror säkert många kvinnor . 
...
Den är numera en ganska opraktisk nödvändighet , bottnande i vår trygghets avhängighet av vanor och konventioner , i våra föreställningar om familjen som garant för omtanken om barnen , för värme och samhörighet , ja t_o_m ' goda seder ' och hög ( sexual- ) moral . 
...
Unga herr far och unga fru mor sätter fortfarande bo med eget linneförråd och servis för tolv personer - och leken går bra så länge den ingenting kräver , d_v_s tills barnen å ena sidan kräver en vårdare på heltid , eller i den maskinellt topprustade lägenheten , på trekvartstid , medan arbetet å andra sidan kräver heltidsengagemang . 
...
Vad betyder t_ex det två gånger om dygnet upprepade rycket från den ena miljön till den andra för daghemsbarnet ? 
Den detaljen är knappast planerad utifrån barnets bästa - men tillmötesgår ju vårt behov att ' äga ' våra barn . 
Först om vi går utanför landet och nuet kan vi få erfarenhet av kollektiv fostran , t_ex från kibbutzerna . 
...
Då är erfarenheterna från helt annorlunda kulturer intressantare , t_ex Margaret Meads från arapeshfolket där pappan hade det huvudsakliga ansvaret för barnavården , men där alla barn kunde söka hjälp hos alla vuxna om pappan eller mamman inte fanns till hands . 
...
Nog törs vi t_ex ifrågasätta om alla våra bostadsområden måste se ut som de gör : travar med likadana topputrustade enheter centrerade kring snabbköp , kiosk och parkeringsplats ? 
...
Det blir allt vanligare att man i födelseannonser ser att föräldrarna har olika efternamn . 
Att på det sättet öppet visa att ett barn är fött ' utom äktenskapet ' skulle i de flesta andra länder vara helt otänkbart - hos oss är det väl knappast längre någon som reagerar . 
Detta innebär inte att förhållandena är oförändrade i andra länder , som exempel kan nämnas den nya synen på skilsmässa i Italien . 
Man måste kanske ändå ställa sig frågan : 
Varför har just vi svenskar blivit så toleranta mot olika former av sammanlevnad och varför blir det hos oss allt vanligare att man bildar familj utan att ingå äktenskap ? 
Antingen är det fel på äktenskapet eller också har våra värderingar förändrats . 
Kanske bådadera . 
Att värderingarna förändrats är helt säkert riktigt , och om någon förnekar det så låt oss jämföra vår reaktion inför upplysningen om att två ungdomar sammanbor med den vi skulle haft för tjugo år sedan . 
Det är här inte bara fråga om ett vagt accepterande av rådande förhållanden . 
Den ' nya ' sexualmoralen har påverkat oss alla men samtidigt djupt oroat oss . 
Mest oroande är att synen på äktenskapet som samlevnadsform förändras i en riktning som ifrågasätter värdet av familjebildning och ansvarstagande i den form som i de flesta kulturer och under sekler varit allmänt rådande . 
Förutvarande justitieminister Kling tillsatte strax före sin avgång en utredning , familjesakkunniga , med utomordentligt specificerade direktiv för utredningsarbetet . 
Enligt direktiven skall lagstiftningen ses som ett medel att påverka utvecklingen och därjämte förändra samhällstrukturen mot ett samhälle där varje vuxen kan ta ansvar för sig själv utan ekonomiskt beroende av anhöriga . 
Äktenskapet är en form av ' frivillig samlevnad mellan självständiga personer ' . 
Särskilt betonas självständigheten i ekonomiskt avseende , var och en skall helt enkelt försörja sig själv i framtiden . 
De flesta människor torde förlova och gifta sig utan närmare tanke på att deras förhållande blir rättsligt reglerat . 
I allmänhet är det först vid äktenskapets upplösning , genom skilsmässa eller genom att en av makarna avlider som rättsverkan träder i funktion . 
Lagens mening att makarna under äktenskapets bestånd skall leva på lika standard och att var och en efter sin förmåga skall bidra till försörjningen är för de flesta självklar . 
Den nya familjelagstiftningen , som kan väntas om några år , kommer att i grunden förinta denna uppfattning . 
I den förändringens tid som vi lever i bör man sträva efter att åtminstone bevara det som är värdefullt . 
Till det mest värdefulla måste räknas människors vilja att ta ansvar för varandra , att försöka att leva i ' viform ' i stället för i ' jagform ' . 
Familjegemenskapen , föräldrars och barns gemensamma ansvar för varandra skapar också trygghet . 
I ett förhållande är aldrig bägge parter lika starka . 
För den svagare har ofta vetskapen om att leva i nära gemenskap med en annan utgjort en ovärderlig tillgång . 
För barnen är det ytterst viktigt att veta att föräldrarna hör samman ' på riktigt ' . 
Äktenskap och politik 
Teol dr Tom Hardt skrev i denna tidskrift en artikel : ' Till storms mot äktenskapet ' där han kommenterade den svenska regeringens rapport i kvinnofrågan till FN . 
Av artikeln framgick klart , att den rapporten måste ses som representativ för det socialdemokratiska partiets familjesyn men att någon majoritet av svenska folket säkert inte står bakom de uppfattningar som förs fram i rapporten . 
Samma slutsats drar jag när det gäller direktiven till familjelagsakkunniga . 
Man vill från socialdemokraternas sida förändra samhället i riktning mot kollektivitet och jämlikhet . 
Eftersom den nuvarande familjebildningen utgör ett hot mot förverkligandet därav måste familjen och äktenskapet förändras . 
Familjen är emellertid konservativ på samma sätt som kärleken ofta är egoistisk . 
Kärlekens innersta väsen lär inte något politiskt parti kunna påverka , men formerna för dess yttringar kan alltid regleras i lag . 
Familjen är också i sin grund kapitalistisk , därför att känslan av ansvar för de närstående främjar sparande och ägandelust . 
Känslan av varaktighet i ett förhållande ökar viljan till investeringar i eget hem och andra kapitalvaror . 
Familjen blir lätt det primära , samhället kommer i andra rummet ; förhållanden som ett socialistiskt parti självfallet bekämpar . 
...
Detta underlättas givetvis genom att samhället tar över en allt större del av ansvaret för barnens vård . 
Den enorma satsningen för att få ut mödrarna i förvärvslivet görs inte enbart därför att dessa skulle eftersträva arbete utom hemmet . 
Bakom finns med all säkerhet också tanken att man genom en kollektiv uppfostran av barnen kan komma närmare ett socialdemokratiskt jämlikhetsideal . 
Skattepolitiken är ett annat verksamt medel att få ut mödrarna i förvärvslivet och därigenom förhindra att barnen får den personliga vård som ges i ett hem . 
Den konservativa uppfattningen att familjen är samhällets grund bygger på en annan ideologi . 
Äktenskapet är ett avtal , och ett bindande avtal . 
Det ställer krav på parternas ansvar såväl för varandra som för barnen . 
Bundenheten i avtalet underlättar samlevnaden och ansvaret begränsas inte till vissa områden . 
' Äktenskapet är av Gud instiftat ' heter det i vigselformuläret , och för de flesta människor innebär äktenskapets ingående ett allvarligt och noga övervägt ställningstagande . 
Vi kan vänta oss en politisk strid om äktenskapet och dess funktion . 
Är det fel på äktenskapet ? 
Frågan är om man med den konservativa grundsynen helt enkelt kan slå bort tanken på att revidera den nuvarande äktenskapslagstiftningen . 
Jag tror inte att man kan det . 
Den starka negativa reaktion som mött direktiven beror på att dessa så detaljerat pekat ut lösningar och eftersträvade förändringar och lämnat mycket lite utrymme åt ställningstaganden från utredningens sida . 
Bl_a anses att den nya lagstiftningen måste vara objektiv till olika samlevnadsformer , och moraliska värderingar får inte förekomma . 
Om man emellertid är helt övertygad om att den för alla parter bästa samlevnadsformen är äktenskapet , så innebär det inte att man gör moraliska värderingar . 
Det innebär i stället att man vill underlätta samlevnaden för dem som vill bilda familj . 
Varför ökar då antalet ogifta familjebildare ? 
Det finns ingen undersökning gjord över vad orsaken är till att familjebildning , med eller utan barn , sker utan att parterna gifter sig . 
Man måste göra antaganden . 
De troliga orsakerna är i första hand tre : 
Det är för besvärligt att gifta sig , det blir bara inte av . 
Man vill inte ' binda sig ' , ( ofta bara en part ) . 
Kärleken är stark nog att klara sig utan yttre band ( tror man ) . 
...
I stället bör man undersöka huruvida inte en registrering skulle kunna utgöra det konstitutiva momentet vid äktenskapets ingående . 
Givetvis kan sedan var och en efter egen vilja komplettera registreringen med vigsel . 
Vad man tycks glömma bort är det personliga engagemanget i det avtal som äktenskaps ingående medför . 
Om någon ' gifter sig ' en lördag , troligtvis i kyrkan där majoriteten av dagens vigslar sker , skulle äktenskapet inte vara giltigt förrän registrering skett , kanske nästkommande onsdag . 
För parterna som önskar vigsel måste det vara en orimlighet att ur vigselformuläret skulle utgå : ' förklarar jag Eder som man och hustru ' . 
En sådan vigsel skulle i hög grad sakna berättigande och bidraga till att formen för äktenskapets ingående reducerades till postandet av ett ifyllt formulär . 
Däremot kan det vara riktigt att man förenklar äktenskapets ingående till en juridiskt bindande överenskommelse med vittnen , varvid detta kan ske antingen i samband med vigsel eller på annat sätt för dem som önskar ett mindre formellt ingående . 
Ofta hör man från moderat håll att ' det skall vara svårt att gifta sig ' . 
Jag tror inte heller det är riktigt . 
Om man vill underlätta för unga familjebildare att ingå äktenskap gör man detta genom att inte i onödan krångla till proceduren . 
Själva avtalet måste emellertid vara det konstitutiva elementet , inte registreringen av detsamma . 
Den andra orsaken till att man inte gifter sig , man vill inte binda sig , kan man knappast komma åt lagstiftningsvägen . 
Den måste ses som en följd av en minskad benägenhet att ta ansvar och som ett tecken på osäkerhet . 
I de fall samlevnaden resulterar i barn kan man dock juridisk reglera förhållandena parterna emellan . 
Teoretiskt kan man resonera så , att har en samlevnad pågått en viss given tid och parterna fått barn tillsammans skall samma regler gälla för sammanlevnaden som om parterna ingått äktenskap . 
Med all sannolikhet skulle en sådan lagstiftning bidraga till att ordna upp de ofta stora svårigheter som uppkommer när förbindelsen bryts genom dödsfall eller genom separation . 
I detta fall skulle vi få ett nytt slags äktenskap , som syftar till att reglera förhållandena familjemedlemmarna emellan och som juridiskt jämställer dessa förhållanden med dem som råder i ett vanligt äktenskap . 
Att kärleken kan klara sig utan yttre band är i de flesta fall sant . 
Vad de som resonerar så glömmer är dels att kärleken inte alltid är beständig och att den i alla händelser inte är evig . 
Förr eller senare blir alltid den ena parten lämnad ensam , och då kommer svårigheterna . 
Arvsrätt och giftorätt finns inte . 
Kanske har hus- och bilköp skett i den avlidnes namn , och den efterlämnade har i så fall ingen rätt till den egendom som under samlevnaden varit gemensam . 
Skulle modern dö och efterlämna barn har fadern inte självklart någon vårdnadsrätt till de barn som han levt och bott med fram till dödsfallet . 
Inte ens umgängesrätt med dem finns reglerad i lag . 
Man skulle önska att alla de som tvärsäkert vet med sig att deras kärlek skall klara alla problem övervägde följderna av att kärleken eller motparten dör . 
Detta ställer stora krav på upplysning . 
Det är märkvärdigt så litet moderna ungdomar vet om rättsverkningar av olika samlevnadsformer . 
Genom en ökad effektiv information kan vi kanske i någon mån göra äktenskapet mer attraktivt . 
Ännu brister det i förfärande hög grad . 
Familjelagstiftning 
Familjelagstiftningen är egentligen inte begränsad till äktenskapet . 
I dagens samhälle premieras emellertid på flera olika sätt sammanboende i förhållande till gifta . 
Även om detta inte sker enligt lagens bokstav är det ett faktum . 
En ensamstående moder har betydligt lättare att få in sitt barn på daghem ( även om hon i verkligheten sammanbor med barnets far ) . 
En studerandes studiemedel behovsprövas gentemot makes inkomst , inte gentemot sammanboendes . 
Genom litet ' skicklighet ' kan de få dubbelt barntillägg . 
Bostadsbidrag kan utgå till den ' ensamstående ' i betydligt högre grad än om föräldrarnas inkomst läggs samman - detsamma gäller arbetsmarknadspolitiska och sociala förmåner av olika slag . 
Där måste en ändring ske . 
Vi kan inte förhindra att familjebildning sker utanför äktenskapet , men vi måste åstadkomma sådana kontrollmöjligheter att ogifta familjer inte får större privilegier än andra . 
Vi upplever i dag en rotlöshet och rådvillhet hos många unga . 
Genom att försvaga äktenskapet ökar vi dessa företeelser och vi gör dem urarva . 
Vi måste i stället försöka skapa ett samhälle byggt på gemenskap människor emellan , och den gemenskapen har sin grund i familjen . 
Det innebär inte , att vi kan bortse från den förändring som skett vad gäller familjens levnadsförhållanden . 
Den lilla tvågenerationsfamiljen går miste om mycket som fanns i forna tiders stora familjer med flera generationer . 
...
Det är inte familjelagstiftarnas sak att i övrigt förbättra relationer mellan människor , det är en uppgift för hela samhället . 
Den socialdemokratiska bostadspolitiken med cellbildning och ålderssegregation har försvårat kommunikationerna mellan människor , skattepolitiken har nedvärderat det personliga ägandet och kollektiviteten har försvårat personliga insatser utöver det vanliga . 
Nu måste vi slå vakt om äktenskapet - medan tid är . . 

رئیس انجمن جراحان قلب ایران تأكید کرد : کلیه امکانات پیشرفته تکنولوژیکی در خصوص انجام اعمال جراحی قلبی در ایران وجود دارد و نیازی به اعزام بیماران به خارج از کشور نیست . 
...
مهندس داوودی شمسی با تأكید بر لزوم واگذاری امور تصدیگری این بخش گفت : در روح قانون تصویبی اخیر در مجلس شورای اسلامی ، شکستن انحصار و لزوم قراردادهای جدید نفتی و گازی ایران وجود دارد . 
...
وی همچنین نسبت به نفوذیها هشدار داد و از آن‌ها با تأكید بر تعبیر امام ) ره ( به آتش‌بیاران معرکه یاد کرد . 
...
از موضع‌گیری ارزشی آقای کروبی در روزنامه‌های همشهری و ایران خبری نیست . 
در برخی از روزنامه‌های دوم‌خردادی به صورت کم‌رنگ این موضع‌گیری منعکس شد ، اما موضع‌گیری آقای بهزاد نبوی به عنوان سخنگوی جبهه دوم خرداد خیلی پررنگ و درشت انعکاس یافت . 
...
با تکرار اصول مشترک و تأكید بر خط امام ، عدم جدایی دین از سیاست و دیگر اصول انقلاب ، ضد‌انقلاب را منزوی و مرزهای خود را با آن‌ها کاملاً مشخص کنید . 
در موضع‌گیری‌های سخنگوی جبهه دوم خرداد همیشه جایگاه تکرار اصول مشترک و تأكید بر خط امام که بدون شک منجر به مرزبندی با عناصر ضد‌انقلاب می‌شود خالی است . 
آنچه که صادر شده است تکرار اطلاعیه‌های قبلی مبنی بر اتخاذ آرامش و سکوت آن هم در برابر رسوایی کنفرانس برلین و تعطیلی روزنامه‌های خاطی است نه آنچه که مورد انتظار مردم و رهبری است . 
اکنون که رهبری نظام اراده کرده است همه نیروهای خودی را با پرچم اصلاحات اسلامی و نیز تأكید بر اصول و آرمانهای اسلام و امام در زیر خیمه نظام جمع کند ، تا مرز اصلاحات آمریکایی با اصلاحات انقلابی مشخص گردد ، چرا عده‌ای در غبارآلود کردن فضای بین صفوف اصرار دارند . 
...
وی در ادامه تأكید کرد : در این شرایط تنها خود شورای نگهبان می‌تواند در جهت تقویت خود اقدام کند . 
سلامتی ، در ادامه با اشاره به تأكید مقام معظم رهبری بر ضرورت توجه به بحث وحدت ملی ، گفت : وقتی در عرصه سیاسی کشور برخوردهای سازنده انجام نمی‌شود این خود زمینه بروز اختلاف است . 
...
پس از انتخابات ۲۹ بهمن و مشخص شدن وضعیت آرای آقای رفسنجانی فشار زیادی از طرف بخشی از کارگزاران به بخش دیگر نیز شروع شد تا به هر نحو ممکن این حزب را از جبهه دوم خرداد خارج کنند به ویژه این که روزنامه هم‌میهن پس از ترور حجاریان و همچنین در فضای تیره و مه‌آلود پخش گزینشی کنفرانس برلین همگامی خود را با روزنامه‌های دیگر دوم‌خردادی بجد از خود نشان داد . 
...
نوربخش تأكید کرد : در سال گذشته بیشترین سرمایه‌گذاری دولت به میزان ۲۶ درصد در بخش صنعت بود که از محل این سرمایه‌گذاری ۲۲۹۵ واحد تولیدی راه‌اندازی شد . 
سرمایه‌گذاری در بخش ساختمان نیز با سیاست‌های تحریک‌کننده دولت بیش از ۹۲ درصد افزایش یافت . 
رئیس کل بانک مرکزی این ادعا که دولت در برنامه‌های اقتصادی خود تسلیم حوادث است ، را رد کرد و با تشریح مشکلات اقتصادی سالهای ۷۶ و ۷۷ بر تأثیر سیاست‌های دولت در شکل‌گیری وضعیت کنونی اقتصادی تأكید کرد . 
...
وزیر فرهنگ و ارشاد اسلامی افزود : تعطیل شدن برخی روزنامه‌ها ، موجب شد شمارگان روزنامه‌های مورد توجه مردم به‌سرعت افزایش یابد و قوه قضائیه نیز وعده داد که این تعطیلی‌ها موقت است و به‌زودی محکمه در این مورد رأى خود را اعلام می‌کند . 
...
سینماگران روسی با اعلام این که سینمای ایران از سینماهای کلاسیک جهان به شمار می‌رود و کتابها و مقالات گوناگونی دربارهٔ آن در جهان به رشته تحریر در آمده است تأكید کردند در حال حاضر هر‌چه فیلمهای سینمایی ایرانی در روسیه بیشتر پخش می‌شود طرفداران بیشتری به خود جذب می‌کند . 
...
تیم ایران از این مسابقه‌ها دو مدال نقره و یک برنز کسب کرده بود . 
مرحله یک چهارم نهایی مسابقات فوتبال جام حذفی باشگاههای ایران ، بعد از ظهر روز سه‌شنبه در شهرهای تهران ، تالش و نوشهر پیگیری شد . 
در پایان این مسابقات تیم‌های سپاهان اصفهان و بهمن کرج با غلبه بر حریفان خود راهی مرحله نیمه‌نهایی شدند . 
در ورزشگاه شهدای نوشهر دیدار رفت تیم‌های استقلال تهران و ایرسوتر نوشهر با نتیجه مساوی یک بر یک به پایان رسید . 
بهمن طهماسبی در دقیقه ۲ برای تیم استقلال تهران و امیدرضا رمضانی در دقیقه ۷۱ برای تیم ایرسوتر در این دیدار گلزنی کردند . 
در ورزشگاه پوریای ولی تالش ، تیم سپاهان موفق شد در ضربات پنالتی با نتیجه ۵ بر ۴ در برابر تیم چوکای تالش به پیروزی برسد . 
وقت قانونی و اضافه این دیدار با نتیجه یک بر صفر به سود تیم سپاهان پایان یافت و با توجه به برد یک بر صفر چوکا در دیدار رفت ، مسابقه به ضربات پنالتی کشیده شد . 
در ضربات پنالتی بازیکنان تیم سپاهان هر پنج ضربه خود را گل کردند ولی یک ضربه پنالتی بازیکنان تیم چوکا توسط اصغر رسول‌زاده به هدر رفت و به این ترتیب چوکا نتیجه بازی را به میهمان اصفهانی خود واگذار کرد . 
داوری این دیدار را محمدعلی فروغی ، با کمک‌های عباس چناری و ایرج شهری‌زادگان بر عهده داشت . 
تیم بهمن در ورزشگاه تختی تهران با نتیجه دو بر یک بر تیم الکتریک دماوند پیروز شد . 
در این دیدار بهزاد مفرح در دقیقه ۳۴ برای تیم الکتریک دماوند گلزنی کرد و داریوش میکائیلی در دقیقه ۳۱ و امین راستی در دقیقه ۸۱ گلهای تیم بهمن را به ثمر رساندند . 
به دلیل آن که تیم‌های بهمن و الکتریک دماوند هر دو از استان تهران هستند ، تنها یک دیدار برگزار کردند و به این ترتیب تیم بهمن به دور نیمه‌نهایی صعود کرد . 
در مرحله نیمه‌نهایی تیم بهمن با تیم سپاهان مسابقه خواهد داد . 
برنده بازی برگشت استقلال تهران و ایرسوتر با سایپا در مرحله نیمه‌نهایی بازی خواهد کرد . 
پکن - ایرنا : 
پیش‌بینی می‌شود حدود یک میلیون کودک چینی همزمان با اول ژوئن ) روز جهانی کودک ( با شرکت در برنامه‌های ویژه آموزشی رایانه‌ای در سراسر این کشور با شبکه جهانی اینترنت بیشتر آشنا شوند و در عین حال با یکدیگر به رقابت بپردازند . 
این یازدهمین فعالیت رقابتی در چین در زمینه اینترنت برای کودکان است که به مناسبت روز جهانی کودک برگزار می‌شود . 
صدها نفر از مردم ژاپن پس از مرگ کیزوابوچی نخست‌وزیر سابق این کشور به بیمارستان‌های ژاپن هجوم برده‌اند تا معاینه کامل مغزی شوند و از سلامت کامل مغزشان اطمینان یابند . 
ابوچی ۲۶ ساله بر اثر سکته مغزی شش هفته در حالت اغما فرو رفت و سرانجام روز یکشنبه درگذشت . 
به گفته مسئولان یکی از بیمارستانهای ژاپن ، پس از سکته مغزی ابوچی و فرو‌رفتن او به حالت اغما ، در مدت یک ماه ۴۴ مورد معاینات مغزی در این بیمارستان انجام شد ، در حالی که در سراسر سال گذشته فقط ۵۰ مورد معاینه مغزی در این بیمارستان انجام شده بود . 
منشی‌های بیمارستان‌های ژاپن هر روز تلفن دهها نفر را پاسخ می‌دهند که خواستار وقت معاینه مغزی هستند . 
تحقیقات پژوهشگران کانادایی نشان داده است که افراد مبتلا به بیماری‌های ریوی در صورت انجام تمرین‌های ورزشی می‌توانند بهبودی خود را به دست آورند . 
این پژوهشگران پس از ۴ سال تحقیق روی بیمارانی که به بیماری‌های شدید تنفسی از قبیل برونشیت مزمن و آمفیزم مبتلا بودند ، نتیجه گرفتند که انجام تمرین‌های ورزشی و نرمش زیر نظر اعضای خانواده می‌تواند بیمار را در وضعیت راحت‌تری قرار دهد و به روند بهبودی او سرعت بخشد . 
این تحقیقات نشان داده است که هرچه شدت بیماری تنفسی بیشتر باشد ، انجام تمرین‌های ورزشی تأثیر بهتری در بهبود آن دارد . 
پژوهشگران انگلیسی اعلام کردند مواد شیمیایی موجود در انواع حشره‌کش‌ها و سم‌های آفات نباتی خطر ابتلا به بیماری پارکینسون را تا ۲ برابر افزایش می‌دهد . 
تحقیقات پژوهشگران نشان داده است که مواد شیمیایی موجود در آفت‌کش‌ها و حشره‌کش‌ها به سلول‌های مغزی آسیب وارد می‌کند و تماس مداوم افراد با این مواد ، خطر بیماری پارکینسون را افزایش می‌دهد . 
یکی از نشانه‌های بیماری پارکینسون لرزش شدید دست‌ها است ، که به واسطه آسیب دیدن سلول‌های ناحیه غده‌های قاعده‌ای مغز صورت می‌گیرد . 
پژوهشگران معتقدند این بیماری بر اثر کاسته شدن از میزان پیام‌برنده‌های عصبی دوپاماین پدید می‌آید . 
رم - ایرنا : 
قضات ایتالیا جولیو آندره اوتی نخست‌وزیر پیشین و سناتور مادام‌العمر این کشور را از اتهام همکاری با مافیا مبرا دانستند . 
مقامات قضایی دادگستری شهر پالرمو واقع در جزیره سیسیل ایتالیا اعلام کردند که دلایل و مدارک کافی برای متهم کردن آندره اوتی وجود ندارد . 
نادمان مافیایی ، سناتور مادام‌العمر ایتالیا را به دیدار با سران سازمان‌های تبهکاری و مشاوره با آن‌ها در مورد سیاست کشور در زمان نخست‌وزیری‌اش ) ۱۹۸۹ تا ۱۹۹۲ ( متهم کرده بودند . 
جولیو آندره اوتی ۸۰ ساله ، ۷ بار به سمت نخست‌وزیر ایتالیا انتخاب شده و ۱۲ بار سمت وزارت را در دولت‌های مختلف این کشور به عهده داشت . 
دهلی نو - ایرنا : 
سونیا گاندی ، رئیس حزب مخالف کنگره به منظور اعتراض به دولت اتل بیهاری واجپایی برای افزایش قیمت کالاهای اساسی ، روز سه‌شنبه از محل پارلمان تا منزل نخست‌وزیر راهپیمایی کرد . 
به گزارش خبرگزاری پی‌تی‌ای ، خانم گاندی گفت : اگر دولت در پس گرفتن تصمیمات مخالف مردم ناموفق عمل کند ، به اعتراض خود ادامه خواهد داد . 
در یادداشتی که سونیا گاندی به نخست‌وزیر هند تسلیم کرد ، آمده است ، حزب کنگره از طریق اقدامات دموکراتیک ، علیه تصمیمات مخالف مردم هند به اعتراض خود ادامه می‌دهد . 
واشنگتن - ایرنا : 
شبکه تلویزیونی سی‌ان‌ان اعلام کرد ، سازمان هوانوردی فدرال آمریکا مصمم است ، به‌زودی نوارهای صوتی و متن آن را انتشار دهد که اطلاعات جدیدی از لحظات آخر پرواز ساقط‌شده ۹۹۰ هواپیمای مصری ، ارائه خواهد کرد . 
این شبکه تلویزیونی خاطرنشان کرد ، اما این اطلاعات ممکن است پرده از روی علت سقوط هواپیما که منجر به کشته شدن ۲۱۷ تن گردید ، برندارد . 
این نوارهای صوتی شامل گفت و گوی مسئولان برج مراقبت با خدمه بواینگ ۷۶۷ - از لحظه‌ای که این هواپیما از باند فرودگاه بین‌المللی جان اف کندی خارج شد ، تا زمانی که به اعماق اقیانوس اطلس در ۹۰ کیلومتری ساحل جنوب شرقی ماساچوست سقوط کرد ، است . 
بعد از شش ماه تفحص و صرف بیش از ۳۱ میلیون دلار پول برای تحقیق در مورد این سقوط ، بازپرسان هیئت ایمنی ملی ترابری هنوز معمای آن را حل نکرده‌اند و هیچ مدرکی دال بر نقص فنی نیز به دست نیامده است . 
تهران - واحد مرکزی خبر : 
پس از دو مأموریت ناموفق ناسا برای کاوش در مریخ ، این سازمان فضایی در حال بررسی ساخت کاوشگری است که بتواند روی یک کیسه هوا فرود آید . 
این کاوشگر یکی از دو طرحی است که ناسا برای پرتاب در سال ۲۰۰۳ میلادی به سوی مریخ در نظر گرفته است . 
طرح دیگر شامل پرتاب فضاپیمایی است که در مدار مریخ قرار خواهد گرفت . 
کاوشگر جدید یک روبات ۲۸۶ پوندی است که پس از رها شدن از چتر خود در سطح مریخ ، به هنگام فرود از یک کیسه هوا استفاده خواهد کرد . 
این کیسه هوا سپس به طور خودکار جمع می‌شود و کاوشگر به‌راحتی به تحقیقات خود خواهد پرداخت . 
تهران - واحد مرکزی خبر : 
خوان فرناندز کرون تبعه اسپانیایی ، عامل سوءقصد نافرجام علیه پاپ در پرتغال در سال ۱۹۸۲ ، در حالی که روز سه‌شنبه در بروکسل به آلبرت دوم پادشاه بلژیک نزدیک می‌شد ، دستگیر شد . 
به گزارش خبرگزاری فرانسه ، این کشیش سابق سنت‌گرای اسپانیایی در حالی که از نرده‌های کاخ پادشاهی بروکسل عبور می‌کرد گفت : من پاپ را نکشته‌ام . 
وی که هیچ گونه سلاحی حمل نمی‌کرد ، توسط پلیس بروکسل دستگیر شد . 
خوان فرناندز کرون قرار است توسط یک روانشناس معاینه شود تا در مورد تحویل یا عدم تحویل وی به بیمارستان تصمیم بگیرد . 
خوان فرناندز کرون ۵۰ ساله بعد از آن که در سال ۱۹۸۲ پاپ ژان پل دوم را در زیارتگاه فاطیمای پرتغال تهدید کرد ، به هفت سال زندان محکوم ولی به‌زودی آزاد شد . 
بن - ایرنا : 
تعداد قربانیان مواد مخدر در آلمان ، بار دیگر به‌شدت افزایش یافت . 
انجمن تخصصی مواد مخدر آلمان در شهر نورنبرگ ، روز سه‌شنبه اعلام کرد ، در چهار ماه نخست سال ۲۰۰۰ میلادی ، ۵۵۷ نفر آلمانی بر اثر اعتیاد به مواد مخدر جان خود را از دست داده‌اند . 
بنا بر این گزارش ، تعداد قربانیان مواد مخدر در چهار ماه نخست سال ۲۰۰۰ میلادی در مقایسه با زمان مشابه در سال گذشته ، شش درصد بیشتر است . 
در سال گذشته میلادی ، یک هزار و ۲۱۸ نفر ، قربانی استعمال مواد مخدر ، از قبیل کوکائین ، هرواین و دیگر مواد مخدر قوی ، در آلمان شدند که در مقایسه با تعداد این قربانیان در سال ۱۹۹۸ ، ۱۱ / ۵ درصد بیشتر بود . 
تیم پیروزی تهران که پیش از این قهرمانیش در مسابقه‌های فوتبال قهرمانی دسته اول باشگاه‌های ایران ) جام آزادگان ( مسجل شده بود و در طول بازیهای لیگ به هیچ یک از تیمها نباخته بود روز سه‌شنبه در دیداری عقب‌افتاده از هفته شانزدهم این پیکارها در حالی که مربی نام آشنای خود علی پروین را در کنار نداشت مقابل تیم صنعت‌نفت آبادان شکست را پذیرا شد . 
در این دیدار که در ورزشگاه تختی آبادان برگزار شد ، تیم صنعت‌نفت آبادان با ۳ گل مقابل تیم پیروزی تهران به برتری دست یافت و ۳ امتیاز حساس این دیدار را به اندوخته‌های خود افزود تا وضعیت خود را در جدول رده‌بندی این پیکارها بهبود بخشد . 
گل‌های تیم صنعت‌نفت در دقیقه ۴۲ توسط امید شریفی‌نسب و ۸۰ و ۸۵ به وسیله مهند مهدی النداوی به ثمر رسید . 
این دیدار را ایرج نظری به کمک‌های اسماعیل صفیری و مهدی هنروری قضاوت کرد . 
تیمهای حذف‌شده بعد از ۵۲ هفته در یک هفته به آخر مسابقات مانده به طور قطع و مسلم چوکا و ایرسوتر به گروه دوم لیگ سقوط کردند ، در آخرین بازی چنان‌چه فولاد اهواز بازی را ببازد و ابومسلم برنده باشد ، فولاد از گردونه خارج خواهد شد و ابومسلم در لیگ ابقا می‌شود . 
اما اگر ابومسلم و فولاد هر دو ببازند ، صنعت‌نفت باید بازی را با حداقل سه گل ببرد تا بتواند در لیگ دست اول باقی بماند . 
اما اگر هر سه تیم ببازند وضع جدول همچنان باقی خواهد ماند . 
دوچرخه‌سوار تهرانی فاتح مرحله ششم تور آذربایجان شد . 
امیر زرگری دوچرخه‌سوار تهرانی عنوان نخست ششمین مرحله از پانزدهمین دوره مسابقه‌های دوچرخه‌سواری بین‌المللی تور استان آذربایجان را به دست آورد . 
زرگری روز سه‌شنبه مسیر ۵۵۱ کیلومتری شهرهای بندر شرفخانه به جلفا را با زمان ۳ / ۶۳ / ۴۳ ساعت طی کرد و به مقام نخست دست یافت . 
رضا راز دوچرخه‌سوار زنجانی و علیرضا حقی دیگر دوچرخه‌سوار تهرانی با ۴ دقیقه و ۶ ثانیه اختلاف در رده‌های دوم و سوم قرار گرفتند . 
در رده‌بندی تیمی و تا پایان دور ششم این رقابتها ، تیم‌های آذربایجان شرقی ، مرکزی و تهران در رده‌های اول تا سوم قرار دارند . 
محمدرضا یزدانی خرم رئیس و سعید درخشنده مسئول روابط عمومی فدراسیون والیبال به منظور شرکت در اجلاس عمومی کنفدراسیون والیبال آسیا ، بعد از ظهر روز سه‌شنبه ، تهران را به سوی شهر بانکوک پایتخت تایلند ترک کردند . 
در این اجلاس که روز ۲۹ اردیبهشت ماه جاری در شهر بانکوک آغاز می‌شود ، مراسم قرعه‌کشی مسابقه‌های والیبال قهرمانی جوانان آسیا که طی روزهای ۲۷ مرداد ماه تا سوم شهریور ماه سال جاری در تهران برگزار خواهد شد ، انجام می‌شود . 
تیم والیبال جوانان ایران در یک بازی دوستانه و تدارکاتی در برابر تیم پیکان تهران با نتیجه ۳ بر صفر شکست خورد . 
اگر ما نقطه‌نظرات آقای مهاجرانی را هم به این قصه اضافه کنیم ناامیدی جناح راست از کشاندن این حزب به جناح حیطه رفتاری مطلوب جناح راست قطعی تلقی می‌شود . 
وی در مصاحبه‌ای با روزنامه بهار اذعان نمود که راز بقای حزب کارگزاران ماندن در جبهه دوم خرداد است . 
به نظر می‌رسد بخش غیر وابسته کارگزاران به خانواده هاشمی در مقابل فشارهای بخش وابسته از مقاومت جدی نشان می‌دهند و همین کافیست که بخش افراطی جناح راست تحمل متحدین سابق خویش را نداشته باشند . 
در حالی که روزنامه هم‌میهن نه روزنامه‌ای بود که تیترهای جنجالی و تند داشته باشد و نه در آن به‌زعم اصحاب کیهان و رسالت و جام و شما و … نفوذیها دیده می‌شد و نه در آن روزنامه مطالبی از عناصر به اصطلاح دگراندیش و سکولار کار می‌شد . 
پس علت توقیف این روزنامه را در چه چیز باید جستجو کرد . 
آن‌هم پس از سخنان مقام رهبری در خطبه‌های نماز جمعه که هفته گذشته جناح‌های موجود در کشور را به همدلی فرا خواند . 
آیا توقیف هم‌میهن را باید در راستای بحران‌سازیهای جناح رقیب تحلیل نمود . 
آیا توقیف روزنامه یادشده را باید آغازی بر تعطیلی بازمانده‌های نشریات دوم‌خردادی دانست به ویژه این که مدیر‌مسوول روزنامه بهار پس از هفت شماره جهت پاره‌ای از توضیحات به دادگاه احضار شده است . 
آیا قرار است اتفاقات جدیدی در مملکت رخ بدهد . 
آیا کار حتی از دست عقلای جناح راست خارج شده است . 
آیا قرار است پروژه لواسانات را … ؟ ! 
به نظر می‌رسد علت توقیف روزنامه هم‌میهن را در بادی امر باید در یک نه جستجو نمود . 
کرباسچی ، به عنوان دبیرکل حزب کارگزاران در تحلیل کلان خویش به همراه یاران خویش به این نتیجه رسیده‌اند که صلاح ملک و مملکت و عقل سلیم در این است که در کنار مجموعه دوم خرداد بمانند . 
مرحله دوم یا میان‌دوره‌ای روزنامه همشهری از قول خبرنگار پارلمانی خود نوشته است : یکی از بحث‌های مطرح در راهروهای مجلس موضوع سرنوشت انتخابات تهران بود . 
اکثر نمایندگان تایید انتخابات تهران را حتمی می‌دانستند ولی در مورد تایید سی نفر و یا کمتر از آن اختلاف نظر داشتند . 
این پرسش نیز وجود داشت که اگر شورای نگهبان آرای چند نفر از نمایندگان تهران را باطل کند انتخاب نمایندگان حذف‌شده در مرحله دوم خواهد بود یا میان‌دوره‌ای ؟ 
بعضی نمایندگان معتقد بودند در صورت حذف چند نفر از نمایندگان تهران ، بر اساس قانون ، انتخابات مرحله دوم حداکثر ظرف یک ماه آینده باید برگزار شود ، در حالی که عده‌ای دیگر با اشاره به خاص بودن مورد انتخابات تهران و این که در طول پنج دوره مجلس هرگز چنین مسئله‌ای برای یک حوزه انتخابیه پیش نیامده اظهار می‌داشتند که چون مرحله دوم انتخابات برگزار شده ، انتخابات تهران به میان‌دوره‌ای کشیده می‌شود . 
عباسی‌فرد عضو شورای نگهبان تایید کرد در صورتی که چند تن از نمایندگان تهران حذف شوند انتخابات باید در مرحله دوم برگزار شود . 
لازم به ذکر است در حوزه‌هایی که انتخابات آن‌ها باطل می‌شود تعیین نمایندگان به انتخابات میان‌دوره‌ای موکول می‌شود ، در حالی که ابطال چند صندوق رأى و کاهش آرای ۵۲ درصدی نمایندگان مشمول مقررات انتخابات میان‌دوره‌ای نشده و باید در مرحله دوم سرنوشت نمایندگان حوزه‌های انتخابیه مشخص شود . 
روزنامه انتخاب با عنوان سه رئوس مثلث اصلاحات نوشته است : سه سال از دورهٔ ریاست‌جمهوری آقای خاتمی پشت سر گذاشته شده است . 
سه سالی که در طول تحولات سیاسی - اجتماعی ایران زمین ، دورهٔ خاص و ویژه‌ای به حساب می‌آید . 
دلیل این ویژه بودن ، هم به بسط ویژه حوزهٔ سیاست و در کل ، به رونق افتادن مسائل و بحث‌های مربوط به اصلاحات است . 
اما در همین مدت ، مردم مسلمان ایران به جهت آزمون مهم و حساسی که در آن قرار داشته‌اند ، بسی نکات نیکو و ناب آموخته‌اند که بسیار می‌تواند آن‌ها را در مسیر دشواری که پیش رو دارند ، یاری و مدد کند : اولین نکته را می‌توان این دانست که پروژهٔ اصلاح به‌مانند همه تحولات اجتماعی - سیاسی دیگر ، طرحی هدفمند ، متکی به برنامه و تدریجی و بطای است که به زمان و حوصله فراوان نیاز دارد و می‌باید مألفه‌های انقلاب اسلامی و فکر ناب دینی ، محور و مدار آن باشد . 
ما بهتر و بیشتر از قبل متوجه این محور مهم شده‌ایم . 
نکتهٔ دیگر به تو‌در‌تو بودن و پیچیده دانستن طرح اصلاحات برمی‌گردد . 
ما پی برده‌ایم که اصلاحات از یک سو ضرورت انقلاب و نیاز کشور است و با نهادهای مدنی و با امنیت و وفاق ملی ارتباط تنگاتنگ دارد . 
...
تحلیلگران آلمانی می‌گویند ، شاید هدف فیشر که تأكید کرد دیدگاهش شخصی است نه دولتی ، جلب توجه مخاطبان داخلی است تا اروپایی . 
...
در حال حاضر یک مطالعه علمی در حال گسترش ، تنبیه بدنی را نه‌تنها برای کنترل کودک بی‌فایده می‌داند ، بلکه بر زیان‌های عاطفی و روانی ناشی از آن در زندگی آینده وی تأكید دارد . 
...
همچنین در این نشست تأكید شده است که سازمان بین‌المللی کار تلاش دارد تا سال ۲۰۱۵ به اهداف خود که همانا کاهش آمار فقر است دست یابد . 
...
همچنین در این نشست با تأكید بر مسئله سواد و آموزش زنان گفته شد که زنان برخی از کشورهای آفریقایی به طور مجانی کار می‌کنند و اجازه ندارند ملکی را برای خود تصاحب کنند . 
تهران - واحد مرکزی خبر : 
طرح کوتاه‌مدت مبارزه با بیماری سل که ۹۹۱ کشور جهان آن را به کار گرفته‌اند ، ناموفق بوده و این موضوع نیازمند اقدام فوری بخش بهداشت عمومی است . 
به گزارش رویتر از شیکاگو ، یافته‌های بررسی سازمان جهانی بهداشت در مورد برنامه‌های مبارزه با بیماری سل در کشورهای جمهوری دومینیکن ، هنگ‌کنگ ، ایتالیا ، روسیه ، آفریقای جنوبی و پرو ، در قالب یک گزارش تهیه و تنظیم شده است . 
در گزارش مذکور آمده است ، این اطلاعات حاکی از آن است که استاندارد شیمی‌درمانی در دوره‌ای کوتاه‌مدت بر اساس داروهای رده اول برای برخی بیماران مبتلا به بیماری سل مقاوم در برابر دارو ناکافی است . 
در بخش دیگری از این گزارش که در هفته‌نامه انجمن پزشکی آمریکا منتشر‌شده آمده است ، به‌رغم این که این طرح درمانی بر پایه مهار بیماری سل قرار گرفته ، این راهبرد باید در برخی مناطق برای تشخیص سریع موارد مقاوم در برابر دارو تعدیل شده و استفاده مناسب از داروهای رده دوم برای درمان صورت گیرد . 
برنامه رده اول که بانک جهانی آن را به عنوان اقتصادی‌ترین شیوه ارزیابی می‌کند ، در‌برگیرنده استفاده از برخی داروها مانند ایزونیازید ، ریفامپیسین ، پیرازنیامید و استرپتومایسین و گاهی اتامبوتول است . 
در سال‌های اخیر در برخی موارد میکرب سل به شکل مقاوم در برابر داروها ظاهر شده است . 
به اعتقاد برخی از متخصصان مشکل در این است که میکرب سل در بیمارانی که تنها با داروهای رده اول درمان شده‌اند ، مقاوم می‌شود . 
اتخاذ راهبردهای درمانی جدید برای مقابله با موارد مقاوم در برابر داروها ، در برخی از کشورها الزامی است . 
ساخارین سرطان‌زا نیست . 
واشنگتن - ایرنا : 
مقامات بهداشتی آمریکا ساخارین را از لیست مواد سرطان‌زا حذف کردند . 
انستیتو ملی علوم بهداشت محیط زیست ، در گزارش سالیانه خود که اخیراً منتشر شد ، اعلام کرده است ، دلیل حذف ساخارین از لیست مواد سرطان‌زا این است که آزمایش‌های جدید نشان داده این ماده که در موش‌ها موجب بروز غدد مثانه می‌شود ، در انسان چنین تأثیری ندارد . 
مدیر انستیتو ملی علوم بهداشت محیط زیست آمریکا گفت : پیشرفت‌های پزشکی برای ما این امکان را به وجود آورده است که با آزمایش‌های جدید و دقیق‌تری به این نتیجه دست یابیم که غدد مثانه در موش ، در اثر مکانیسمی به وجود می‌آید که در مورد انسان صدق نمی‌کند . 
وی گفت : ضمناً اطلاعات به دست آمده در یک دهه گذشته ، در مورد استفاده انسان از این ماده نیز در این تصمیم‌گیری مؤثر بود . 
این انستیتو علاوه بر ساخارین ، اتیل اکریلت ، ماده‌ای که در تولید رنگ‌های پلاستیکی و نساجی از آن استفاده می‌شود را نیز از لیست مواد سرطان‌زا خارج کرد . 
دود سیگار باعث جهش ژنتیکی منجر به سرطان می‌شود . 
تهران - واحد مرکزی خبر : 
ترکیبات شیمیایی که بر اثر سوخت و سایر مواد ارگانیک همچون دخانیات تشکیل می‌شود ، می‌تواند به جهش ژنی که اغلب در بیماران مبتلا به سرطان مشاهده شده ، بیانجامد . 
به گزارش خبرگزاری فرانسه ، طبق مطالعات منتشره در روزنامه مؤسسه ملی سرطان‌شناسی آمریکا ، این ترکیبات که از نوع هیدروکربن‌های حلقومی اروماتیک است ، همچنین بر اثر احتراق بنزین و گازوایل نیز تولید می‌شود . 
اما افراد سیگاری مقدار زیادی از این ترکیبات را به بدن خود وارد می‌کنند . 
این ترکیبات باعث تغییر در ژن پی ۳۵ که از‌بین‌برنده تومور است می‌شود . 
جهش این ژن در میان ۶۰ درصد از مبتلایان به سرطان ریه مشاهده شده است . 
محققان این پژوهش می‌گویند : جهش ژن پی - ۳۵ در‌ نزد سیگاری‌ها در نقطه‌های خاصی از این ژن صورت می‌گیرد ، در صورتی که در میان غیرسیگاریها ممکن است به طور تصادفی در نقطه‌های مختلفی از ژن دیده شود . 
یکی از پژوهشگران این طرح می‌گوید : دود سیگار اصلی‌ترین عامل ایجادکننده سرطان در محل کار است و سیگار عامل ۷۸ درصد سرطان‌های ریه در بیماران آمریکایی به شمار می‌رود . 
نسخهٔ رایانه‌ای مشکل بدخطی پزشکان را حل می‌کند . 
واشنگتن - ایرنا : 
مشکل بدخطی نسخه‌های پزشکی که در بسیاری از کشورها وجود دارد ، به‌زودی کاهش خواهد یافت . 
با ورود رایانه‌های جیبی متصل به اینترنت به بازار ، بسیاری از پزشکان نیز به‌تدریج از این دستگاه‌ها برای نوشتن و ارسال مستقیم نسخه بیماران استفاده می‌کنند . 
این روش ، هم به صرفه‌جویی در هزینه‌ها و وقت بیمار کمک می‌کند و هم خطر اشتباه خوانده شدن نسخه‌ها و بی‌دقتی‌های دیگر را از بین می‌برد . 
رایانه‌های جیبی که مدل‌های مختلفی از آن در بازار وجود دارد به پزشکان امکان می‌دهد که با داروخانه مورد نظر بیمار ارتباط رایانه‌ای برقرار کنند و دستور تهیه داروهای مورد نیاز بیمار را به داروخانه بدهند . 
در این صورت ، بیمار بدون نسخه‌های بدخط به داروخانه رفته و داروی خود را دریافت خواهد کرد . 
در حال حاضر حدود ۵ هزار نفر از پزشکان در آمریکا به جای نوشتن نسخه از روش سفارش رایانه‌ای دارو به داروخانه استفاده می‌کنند . 
پیش‌بینی می‌شود که تا سال ۲۰۰۵ میلادی اکثریت نیم میلیون نفر پزشک موجود در آمریکا ، نسخه نوشتن روی کاغذ را کنار بگذارند . 
ایست ! 
دکترها وقتی دلیل واضحی برای فوت بیمار پیدا نمی‌کنند ، علت مرگ را ایست قلبی ذکر می‌کنند . 
بنابراین باید دلیل توقیف بعضی از روزنامه‌ها را هم ایست چاپی دانست ! 
گل مروارید با وجودی که حالت تهوع و استفراغ‌های صبحگاهی مشکلات فراوانی برای مادران باردار در سه‌ماهه اول بارداری ایجاد می‌کند ، اما بنظر می‌رسد که برای تغذیه مناسب جنین ضروری است . 
پژوهشگران مؤسسه علوم بهداشتی آکسفورد در کشور انگلیس می‌گویند : زنانی که طی سه ماه اول دوران بارداری دچار تهوع و استفراغ صبحگاهی می‌شوند بسیار کمتر از سایر مادران باردار دچار سقط جنین می‌شوند و نوزادان آنان در زمان تولد وزن بیشتری دارند . 
پژوهش‌ها نشان می‌دهد که در سه‌ماهه اول دوران بارداری ، انسولین بیشتری در خون مادران باردار ترشح می‌شود و افزایش میزان انسولین موجب سوخت و ساز بیشتر چربی در بدن این مادران می‌گردد . 
بروز تهوع و استفراغ صبحگاهی ترشح هورمون انسولین در بدن را تنظیم می‌کند ، در‌نتیجه تغذیه مناسب‌تری برای جنین در حال رشد فراهم می‌شود . 
زنانی که قبل از شروع دوران بارداری لاغر هستند و ذخیره چربی کمی دارند ، در دوران بارداری کمتر دچار تهوع و استفراغ می‌شوند و علت آن نیاز بدن آنان به تجمع بافت چربی است . 
از سه فصل دیگر سال کمتر حرفی به میان می‌آید . 
علت ، آن است که در اقلیم زبان فارسی ، ، بهار ، فصل اعتدال ، شکفتگی ، جوانی ، و لطافت است ، و ایرانیان ذاتاً زندگی‌دوست بوده‌اند ، و بخصوص در دورانهای سخت زندگی ، حسرت شاد زیستن را در خود بیدارتر نگاه می‌داشته‌اند . 
در شعر فارسی ، از رودکی تا خیام و حافظ ، بهار فصل عشق‌انگیز خوانده شده ، و زیباترین ساعت‌های عمر با آن پیوند خورده است ، از رودکی آغاز می‌شود ؛ آمد بهار خرم با رنگ و بوی طیب ، با صد هزار نُزهت و آرایش . 
عجیب شاید که مرد پیر بدینگه شود جوان . 
گیتی بدیل یافت شباب از پی مشیب ، آن ابر بین که گرید چون مرد سوگوار . 
و آن رعد بین که نالد چون عاشق کایب ، اکنون خورید باده و اکنون زاید شاد . 
کاکنون برد نصیب ، حبیب از بر حبیب . 
اتفاق خوب آن شده که پایان یافتن شاهنامه نیز ، در بهار متصور گردیده ، این چند بیت فرجامین کتاب : سرآمد کنون قصهٔ یزدگرد ، به ماه سفندارمذ روز اِرد . 
ز هجرت شده پنج هشتاد بار ، به نام جهان داور کردگار . 
چو این نامور نامه آمد به بُن ، زمن روی کشور شود پرسُخُن . 
از آن پس نمیرم که من زنده‌ام ، که تخم سخن من پراکنده‌ام هر آن کس که دارد هُش و رأى و دین ، پس از مرگ بر من کند آفرین . 
اگر ۴۰۰ هجری را پایان کار شاهنامه بگیریم مطابق با ۳۸۸ شمسی و ۱۰۰۹ میلادی ، عمر این کتاب فرخنده سر می‌زند به ۱۰۰۰ سال ، منهای ۹ سال . 
این دوران را باید هزارگان فردوسی خواند ، زیرا هیچ فردی در طی این هزار سال بیش از فردوسی در سرنوشت این کشور اثر‌گذار نبوده و هیچ کتابی به اندازهٔ شاهنامه ، در ساحت ملی و فضای فکری ایرانی حضور نداشته است . 
ایرانسرای فردوسی بر اثر این واقعیت ایجاد گشت ، و شایسته شناخته شد که به فرخ‌داشت این هزارگان فردوسی ، بنای یادگاری در زادگاه او ، توس ، بنیاد گردد . 
ایرانسرای فردوسی چگونه جایی خواهد بود ؟ 
ما آرزومندیم که این بنا در بوستانی قرار گیرد که با شکفتگی ، گوناگونی و دلگشائی خود ، نیم‌رخ روشن تاریخ ایران را در برابر چشم بنهد . 
ایران بخصوص در دوران بعد از اسلام ، بر پایهٔ فرهنگ ، بر خود قائم بوده است ، و شاهنامه بر تارَک این فرهنگ قرار داشته . 
تنها طبیعت در تناوب بهار و خزان می‌تواند نشان دهد که چگونه این کشور ، هرچند‌گاه پس از یک دوران برگ‌ریزان از نو به سرسبزی روی نهاده است . 
فردوسی می‌گفت : که ایران چو باغی است خرم ، بهار شکفته همیشه گل کامکار . 
این وصف و این آرزو را اکنون تجسم دهیم . 
فضائی که ایرانسرا را در بر خواهد گرفت و باغ ایران خواهد بود ، لااقل یک مساحت ۲۰۰ هزار متری را شامل می‌شود ، و در آن درخت‌ها و بوته‌ها و گل‌هایی که در شاهنامه از آن‌ها نام برده شده ، و نیز همهٔ آن‌ها که با آب و هوای خراسان سازگار باشند ، به کار برده خواهند شد . 
هم‌چنین در آن خواهند بود مرغانی که نامشان در کتاب فردوسی آمده ، چون طاووس و تذرو و دراج و بلبل … باضافهٔ حیوانات لطیف و زیبا از نوع آهو و گوزن و مرال … روح بیننده با تماشای این حیوانات بی‌آزار و معصوم تلطیف می‌شود . 
سبزه و گل و پرنده و حیوان ، انسان را به دوره‌هایی که او هنوز با طبیعت انس داشت باز می‌گردانند و ساعتی او را از خشونت محیط ماشین‌زده منفک می‌دارند . 
صدای آب در گوش آدمی از هر موسیقیی دلنوازتر است ، زیرا با رشتهٔ حیات او پیوند دارد . 
روندگی آب همان روندگی تاریخ و روندگی زندگی است . 
با جوی آب و سبزه و درخت و صدای مرغ و نگاه آهو ، پیمان خود را تجدید کنیم . 
بنایی که امیدواریم به نام فردوسی بر پای داریم ، باید نموداری از فرهنگ ایران باشد ، با همان صلابت و انعطاف ، معماری ایران از تخت جمشید و ایوان مدائن ، تا برسد به آرامگاه اسماعیل سامانی در بخارا ، سپس بناهای اصفهان ، همگی با زمان جلو آمده ، ولی همواره بر یک خط حرکت کرده‌اند . 
عمق روح ایرانی در آن‌ها نهفته است . 
استواری و راستایی در ستون‌ها ، انعطاف در قوس طاق ، و ظرافت و باریکی در گلدسته‌ها ؛ و این همان صفات است که فکر ایرانی در دوره‌های مختلف تاریخ خود بازتاب داده است . 
در بنای یادگار فردوسی باید گذشته به حال پیوند بخورد . 
باید به گویاترین نحو تجسم یابد که ایرانی به گذشتهٔ پربارش پشتگرم است و رو به آینده دارد . 
بنا شامل موزه ، کتابخانه و تالارهای اجتماعات خواهد بود ، در کتابخانه‌اش امیدواریم که کل کتابهای مربوط به تاریخ و تمدن و فرهنگ ایران به زبانهای مختلف گرد آیند ، باضافهٔ ترجمه‌های شاهنامه به زبانهای دیگر و بررسی‌هایی که دربارهٔٔ این کتاب بزرگ شده است . 
در مجموع ، خزانه‌ای خواهد بود از کارنامهٔ ایران ، در عرصهٔ جهان ، و امید هست که از این طریق این کشور گرانبار ، آن گونه که بوده است ، هم در چشم مردم خود و هم در چشم جهانیان ، شناخته گردد ، و بخصوص جوانانش پی برند که وابسته به چه سرزمین پر‌معنایی هستند . 
این شناخت و این خودآگاهی ، امروز بیشتر از همیشه ضرورت دارد . 
زیرا در آستانهٔ دنیای تازه‌ای قرار داریم که برای روبرو شدن با آن باید همهٔ نیروها و همهٔ ذخایر فرهنگی خود را فرا خوانیم . 
و البته این بنا و این باغ ماهیتش به گونه‌ای است که باید با کمک مالی فردفرد ایرانی موجودیت یابد . 
باید همهٔ ایرانیان از کودک و زن و مرد در آن سهیم گردند . 
هرچه عده بیشتر باشد ، نشانهٔ آگاهی و دلبستگی گسترده‌تری خواهد بود ، و نشانهٔ آن که آیندهٔ کشور بر پایهٔ محکم‌تری قرار خواهد داشت . 
قرار است که نام یک‌یک کمک‌کنندگان در دفتر زرینی ثبت گردد و در موزهٔ ایرانسرا محفوظ بماند . 
اما مهم‌ترین هدف ایرانسرا آن است که به ایجاد یک حرکت فرهنگی سالم در کشور کمک کند ، بدان گونه که جوانان ایران بر دستاوردهای تمدنی کشور خود واقف گردند ، و در پیوند سالم با فرهنگ جهانی ، آن‌ها را برای آینده توشهٔ راه قرار دهند . 
به همین علت تهیهٔ یک سلسله کتاب دربارهٔٔ تاریخ و تمدن ایران و جهان برای جوانان جزو برنامهٔ کار این مرکز قرار گرفته است ، و امید است که زمینهٔ تألیف آن‌ها فراهم گردد . 
اکنون بیاییم بر سر این سؤال که ایرانسرا در چه مکانی می‌تواند جای گیرد ، بحث کنیم . 
نظامی عروضی نخستین کسی است که قدری با تفصیل ما را در جریان زندگی فردوسی می‌گذارد ، هر چند که بخشی از سخنانش با داستان‌پردازی همراه است . 
برخی از اطلاعات او از جهت آن که با اظهارات خود حکیم در شاهنامه هم‌خوانی دارد ، قابل‌قبول و ارزنده است . 
نظامی صد سالی بعد از مرگ فردوسی به توس سفر کرده است و چون مرد کنجکاوی بوده ، اخباری را که راجع به زندگی فردوسی و خانواده‌اش بر سر زبانها بوده ، به خاطر سپرده . 
مردم توس هنوز بیش از دو عمر از دوران شاعر دور نشده بوده‌اند ، و چیزهایی را که دهان به دهان می‌گشته ، به یاد می‌داشتند ، هر چند که تخیل ایرانی اینگونه مطالب را بی‌شاخ و برگ نمی‌گذارد ، و دلخواه خود را بر آن می‌افزاید . 
نظامی می‌گوید : زادگاه فردوسی باژ بوده است . 
از ناحیهٔ طبران و این باژ بزرگ دیهی است و از وی هزار مرد بیرون آید . 
توس تشکیل می‌شده است از دو شهر طابران و نوقان که به هم متصل بوده‌اند . 
لسترنج می‌نویسد که توس در قرن چهارم دومین شهر ربع نیشابور محسوب می‌گردید . 
یاقوت حموی نوشته است که پیش از حملهٔ مغول هزار دهکده در محوطه توس بوده است ، که نزدیک به تمام آن‌ها در حملهٔ مغول ویران می‌شود . 
باژ که زادگاه فردوسی معرفی شده ، در ناحیهٔ طابران یکی از این هزار ده است . 
هم‌اکنون در هجده کیلومتری شرق توس ، دهکده‌ای است با قلعه‌ای قدیمی ، به همین نام باژ و این سؤال را پیش می‌آورد که آیا این همان آبادی است که فردوسی در آن چشم به جهان گشوده ؟ 
اگر چنین باشد ، این پرسش دیگر به ذهن می‌رسد که چرا فردوسی در یک محل زندگی کرده و در فاصلهٔ سه‌فرسخی آن به خاک سپرده شده است ؟ 
نظامی تصریح دارد که چون مانع دفن او در گورستان مسلمانان شدند ، بناچار جنازه را آورده در باغ ملکی او به خاک سپردند . 
عبارت چهار مقاله این است : درون دروازه باغی بود ، ملک فردوسی ، او را در آن باغ دفن کردند . . 

...
#qf="--quadratic u:"
    ...
    python eval_searn.py --preds $featsbasepath/$l_short.test.pred --feats $featsbasepath/$l_short.test.tokf
    ...
    python eval_searn.py --preds $featsbasepath/$l_short.dev.pred --feats $featsbasepath/$l_short.dev.tokf
done
#!/usr/bin/env bash
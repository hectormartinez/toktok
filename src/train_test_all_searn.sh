...
#qf="--quadratic u:"
    ...
    /home/alonso/tool/vowpal_wabbit/vowpalwabbit/vw -d $featsbasepath/$l_short.train.tokf -f $featsbasepath/$l_short.tok.mdl -b 24 --search 2 --search_task sequence
    ...
    python eval_searn.py --preds $featsbasepath/$l_short.test.tpred --feats $featsbasepath/$l_short.test.tokf
    ...
    python eval_searn.py --preds $featsbasepath/$l_short.dev.tpred --feats $featsbasepath/$l_short.dev.tokf
done
#!/usr/bin/env bash
...
do
    ...
    python3.4 generate_features.py --train_file $treebankbasepath/"$l_short"-ud-train.conllu.lex > "$l_short".all.train.tokf
    python3.4 generate_features.py  --train_file $treebankbasepath/"$l_short"-ud-all.conllu.lex --test_file $rawtextbasepath/bible/"$l_short" > "$l_short".bible.tokf
    python3.4 generate_features.py  --train_file $treebankbasepath/"$l_short"-ud-all.conllu.lex --test_file $rawtextbasepath/watchtower/"$l_short" > "$l_short".watchtower.tokf

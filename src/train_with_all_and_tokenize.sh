...
do
    ...
    python generate_features.py  --train_file $treebankbasepath/"$l_short"-ud-all.conllu.lex --test_file $rawtextbasepath/bible/"$l_short" > "$l_short".bible.tokf
    python generate_features.py  --train_file $treebankbasepath/"$l_short"-ud-all.conllu.lex --test_file $rawtextbasepath/watchtower/"$l_short" > "$l_short".watchtower.tokf
